              ...
              >
                <div style={{ color: ACCENT_COLOR, fontFamily: FONT_FAMILY }}>
                  <p>
                    ...
                    <br /> Cross-browser compatibility was a challenge during
                    the "browser wars," and the introduction of CSS in the
                    mid-1990s began improving design flexibility. <br />
                ...
                <div style={{ color: ACCENT_COLOR, fontFamily: FONT_FAMILY }}>
                  <p>
                    ...
                    todays standards, its the grandparent of all websites ever.
                  </p>
                  <a
